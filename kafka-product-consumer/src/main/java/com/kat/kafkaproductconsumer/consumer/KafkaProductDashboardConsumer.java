...
@Service
@Slf4j
public class KafkaProductDashboardConsumer implements KafkaProductConsumer {

    @Override
    @KafkaListener(topics = "${kafka-product-consumer.product-topic}", groupId = "p-dashboard-cg")
